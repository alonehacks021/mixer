...
<html direction="rtl" dir="rtl" style="direction: rtl" >
	...
	<head><base href=""/>
		...
		<link href="{{asset('vendor/dashboard/metronic/metronic-25/css/plugins.bundle.css')}}" rel="stylesheet" type="text/css" />
		<link href="{{asset('vendor/dashboard/metronic/metronic-25/css/style.bundle.rtl.css')}}" rel="stylesheet" type="text/css" />
	...
	<body id="kt_app_body" data-kt-app-header-fixed-mobile="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" data-kt-app-aside-enabled="true" data-kt-app-aside-fixed="true" data-kt-app-aside-push-header="true" data-kt-app-aside-push-toolbar="true" data-kt-app-aside-push-footer="true" class="app-default"
		x-init="initPage()" x-on:alert="showAlert">
			...
			<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
				...
				<div id="kt_app_header" class="app-header d-flex d-lg-none">
					...
					<div class="app-container container-fluid d-flex align-items-stretch" id="kt_app_header_container">
						...
						<div class="d-flex align-items-center ms-n2 me-2" title="مشاهده sidebar menu">
						...
						<div class="d-flex align-items-center me-auto">
							<a href="../../demo25/dist/index.html">
								<img alt="Logo" src="{{env('APP_LOGO') ?? asset('vendor/dashboard/img/logo.png')}}" class="h-25px" />
							</a>
						</div>
						<!--end::Logo-->
						<!--begin::کناری toggle-->
						<div class="d-flex align-items-center ms-2 me-n1" title="مشاهده header menu">
				...
				<div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
					...
					<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="100px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
						...
						<div class="app-sidebar-logo d-none d-lg-flex flex-center pt-10 mb-3" id="kt_app_sidebar_logo">
							...
							<a href="../../demo25/dist/index.html">
								@if (env('APP_LOGO'))
								<img alt="Logo" src="{{env('APP_LOGO')}}" class="h-50px" />
								@else
								<img alt="Logo" src="{{asset('vendor/dashboard/img/logo.png')}}" class="h-40px bg-white rounded-circle p-1" />
								@endif
							</a>
							<!--end::Logo image-->
						</div>
						...
						<div class="app-sidebar-menu d-flex flex-center overflow-hidden flex-column-fluid">
							...
							<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper d-flex hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu, #kt_app_sidebar" data-kt-scroll-offset="5px">
								...
								<!--begin::Menu-->
								<div class="menu menu-column menu-rounded menu-active-bg menu-title-gray-700 menu-arrow-gray-500 menu-icon-gray-500 menu-bullet-gray-500 menu-state-primary my-auto" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expو="false">

									@foreach (trans_array('dashboard::livewire-layout-menu.sidebar') as $menu)

									@php
									$hasSubmenu = count($menu['submenu'] ?? []) > 0;
									@endphp

									@if (!$hasSubmenu && ($menu['policy'] ?? false))
									@cannot($menu['policy']['method'], $menu['policy']['model'])
										@continue
									@endcannot
									@endif

									@php
									$link = (($menu['route'] ?? null) ? route($menu['route']) : (
										($menu['path'] ?? null) ? url($menu['path']) : $menu['url']
									));
									$isHere = (trim(parse_url($link, PHP_URL_PATH), '/') == trim(request()->path(), '/'));
									@endphp
                                    
									<!--begin:Menu item-->
									<div {!! $hasSubmenu ? 'data-kt-menu-trigger="{default: \'click\', lg: \'hover\'}"' : null !!}
										data-kt-menu-placement="left-start" 
										class="menu-item {{$isHere ? 'here' : null}} show py-2"
										data-bs-toggle="tooltip" 
										title="{{$menu['title']}}">
										<!--begin:Menu link-->

										<a href="{{ $hasSubmenu ? '#' : $link }}" {!! (!$hasSubmenu && ($menu['navigate'] ?? false)) ? 'wire:navigate' : null !!}  class="menu-link menu-center">
										...
										<div class="menu-sub menu-sub-dropdown px-2 py-4 w-250px mh-75 overflow-auto">
											...
											{{-- <div class="menu-item">
												<div class="menu-content">
													<span class="menu-section fs-5 fw-bolder ps-1 py-1">{{$menu['title']}}</span>
												</div>
											</div> --}}

											@foreach ($menu['submenu'] as $submenu)

											@if ($submenu['policy'] ?? false)
											@cannot($submenu['policy']['method'], $submenu['policy']['model'])
												@continue
											@endcannot
											@endif

											@php
											$link = (($submenu['route'] ?? null) ? route($submenu['route']) : (
												($submenu['path'] ?? null) ? url($submenu['path']) : $submenu['url']
											));
											$isHere = (trim(parse_url($link, PHP_URL_PATH), '/') == trim(request()->path(), '/'));
											@endphp
											<!--begin:Menu item-->
											<div class="menu-item">
												<!--begin:Menu link-->
												<a class="menu-link {{$isHere ? 'active' : null}}" href="{{$link}}" {!! ($submenu['navigate'] ?? false) ? 'wire:navigate' : null !!}>
								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex align-items-stretch">
									...
									<div class="app-toolbar-wrapper d-flex flex-stack w-100">
										...
										<div class="page-title d-flex flex-column justify-content-center me-3 mb-0">
											<!--begin::Title-->
											<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center me-3 my-0">{{$title ?? 'پیشخوان'}}</h1>
											<!--end::Title-->
										</div>
										<!--end::Page title-->
										<!--begin::Actions-->

										<div class="d-flex align-items-center gap-2 gap-lg-3" id="header-buttons">
											<div>
												{{jdate()->format('%A Y/m/d')}} &nbsp;
						...
						<div id="kt_app_footer" class="app-footer">
							...
							<div class="app-container container-fluid d-flex flex-column flex-md-row flex-center flex-md-stack py-3">
								...
								<div class="text-dark order-2 order-md-1">
									...
									<a href="https://nahad.ir" target="_blank" class="text-gray-800 text-hover-primary">
					...
					<!--end:::Main-->
					<!--begin::aside-->
					<div id="kt_app_aside" class="app-aside flex-column z-inde-1" data-kt-drawer="false" data-kt-drawer-name="app-aside" data-kt-drawer-activate="{default: false, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="100px" data-kt-drawer-direction="end" data-kt-drawer-toggle="#kt_app_aside_mobile_toggle">
						<!--begin::Navbar-->
						<div class="app-navbar flex-stack flex-shrink-0 p-5 pt-lg-12 pb-lg-8 px-lg-14" id="kt_app_aside_navbar">
							...
							<div class="d-flex align-items-center me-5 me-lg-10">
										...
										<div class="menu-item px-3">
											<div class="menu-content d-flex align-items-center px-3">
												...
												<div class="d-flex flex-column">
													...
													<span class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{{auth()->user()->type_text}}</span></div>
								...
								<!--begin:Info-->
								<div class="d-flex flex-column">
									<a href="#" class="app-navbar-user-name text-gray-900 text-hover-primary fs-5 fw-bold">{{auth()->user()->full_name}}</a>
									<span class="app-navbar-user-info text-gray-600 fw-semibold fs-7">کاربر {{auth()->user()->type_text}}</span>
								</div>
								<!--end:Info-->
							</div>
							<!--end:نویسنده-->
						...
						<!--end::Navbar-->
						<!--begin::Content-->
						<div id="kt_app_aside_content_wrapper" class="app-aside_content-wrapper hover-scroll-overlay-y ps-5 ps-lg-14 pe-3 pe-lg-14 pb-10" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_aside_navbar" data-kt-scroll-wrappers="#kt_app_aside_content" data-kt-scroll-offset="5px">
			
							@includeIf('client.aside')
		...
		<!--begin::Toast-->
		<div id="kt_docs_toast_stack_container" class="toast-container position-fixed top-0 start-0 p-3 z-index-5">
		...
		<script src="{{asset('vendor/dashboard/metronic/metronic-25/js/plugins.bundle.js')}}"></script>
		<script src="{{asset('vendor/dashboard/metronic/metronic-25/js/scripts.bundle.js')}}"></script>
		...
		function showAlert(event) {
			...
			var html = Array.isArray(data.messages) ? `<ul><li class="text-start">${data.messages.join('</li><li class="text-start">')}</li></ul>` : data.messages;
